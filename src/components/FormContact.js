        ...
        return ( <div class="container">
                ...
                <form class="form-horizontal" onSubmit={handleSubmit(this.save.bind(this))}>
                    <div class={'form-group' + (username.touched && username.error ? ' has-error' : '')}>
                        <label class="col-xs-4 control-label"><Term mkey="lbl_username"/></label>
                    ...
                    <div class={'form-group' + (email.touched && email.error ? ' has-error' : '')}>
                        <label class="col-xs-4 control-label"><Term mkey="lbl_email"/></label>
                    ...
                    <div class={'form-group' + (age.touched && age.error ? ' has-error' : '')}>
                        <label class="col-xs-4 control-label"><Term mkey="lbl_age"/></label>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-lg" style={{ margin: 10 }}
                                disabled={submitting}>
                            {submitting ? <i class="fa fa-cog fa-spin"/> : <i class="fa fa-paper-plane"/>} Submit
                        </button>
                        <button type="button" class="btn btn-default btn-lg" style={{ margin: 10 }}
